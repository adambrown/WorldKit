...
private val LOGGING_PRINT_STREAM = if (LOG_TO_SYS_OUT) {
    loggingPrintStream(System.out)
} else {
    loggingPrintStream(File(LOGGING_PATH).outputStream().buffered())
}
...
fun trace(message: () -> Any?) {
    InternalLogging.log(LoggingLevel.TRACE, message)
}

fun debug(message: () -> Any?) {
    InternalLogging.log(LoggingLevel.DEBUG, message)
}

fun info(message: () -> Any?) {
    InternalLogging.log(LoggingLevel.INFO, message)
}

fun warn(message: () -> Any?) {
    InternalLogging.log(LoggingLevel.WARN, message)
}

fun error(message: () -> Any?) {
    InternalLogging.log(LoggingLevel.ERROR, message)
}

fun fatal(message: () -> Any?) {
    InternalLogging.log(LoggingLevel.FATAL, message)
}

fun trace(message: () -> Any?, error: Throwable?) {
    InternalLogging.log(LoggingLevel.TRACE, message, error)
}

fun debug(message: () -> Any?, error: Throwable?) {
    InternalLogging.log(LoggingLevel.DEBUG, message, error)
}

fun info(message: () -> Any?, error: Throwable?) {
    InternalLogging.log(LoggingLevel.INFO, message, error)
}

fun warn(message: () -> Any?, error: Throwable?) {
    InternalLogging.log(LoggingLevel.WARN, message, error)
}

fun error(message: () -> Any?, error: Throwable?) {
    InternalLogging.log(LoggingLevel.ERROR, message, error)
}

fun fatal(message: () -> Any?, error: Throwable?) {
    InternalLogging.log(LoggingLevel.FATAL, message, error)
}

fun trace(error: Throwable) {
    InternalLogging.log(LoggingLevel.TRACE, error = error)
}

fun debug(error: Throwable) {
    InternalLogging.log(LoggingLevel.DEBUG, error = error)
}

fun info(error: Throwable) {
    InternalLogging.log(LoggingLevel.INFO, error = error)
}

fun warn(error: Throwable) {
    InternalLogging.log(LoggingLevel.WARN, error = error)
}

fun error(error: Throwable) {
    InternalLogging.log(LoggingLevel.ERROR, error = error)
}

fun fatal(error: Throwable) {
    InternalLogging.log(LoggingLevel.FATAL, error = error)
}
...
val LOG = object : Log {
    ...
    override fun trace(message: () -> Any?) = wk.internal.application.trace(message)

    override fun debug(message: () -> Any?) = wk.internal.application.debug(message)

    override fun info(message: () -> Any?) = wk.internal.application.info(message)

    override fun warn(message: () -> Any?) = wk.internal.application.warn(message)

    override fun error(message: () -> Any?) = wk.internal.application.error(message)

    override fun fatal(message: () -> Any?) = wk.internal.application.fatal(message)

    override fun trace(message: () -> Any?, error: Throwable?) = wk.internal.application.trace(message, error)

    override fun debug(message: () -> Any?, error: Throwable?) = wk.internal.application.debug(message, error)

    override fun info(message: () -> Any?, error: Throwable?) = wk.internal.application.info(message, error)

    override fun warn(message: () -> Any?, error: Throwable?) = wk.internal.application.warn(message, error)

    override fun error(message: () -> Any?, error: Throwable?) = wk.internal.application.error(message, error)

    override fun fatal(message: () -> Any?, error: Throwable?) = wk.internal.application.fatal(message, error)

    override fun trace(error: Throwable) = wk.internal.application.trace(error)

    override fun debug(error: Throwable) = wk.internal.application.debug(error)

    override fun info(error: Throwable) = wk.internal.application.info(error)

    override fun warn(error: Throwable) = wk.internal.application.warn(error)

    override fun error(error: Throwable) = wk.internal.application.error(error)

    override fun fatal(error: Throwable) = wk.internal.application.fatal(error)
}