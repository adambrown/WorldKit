...
fun UiLayout.BLOCK_GLYPH_NEW_FILE(scale: Float): Block.() -> Block {
    ...
    return createMultiGlyph(GlyphLayer(
            GLYPH_FILE, glyphFont, 16.0f * rescale,
            COLOR_GLYPH_WHITE, 0.0f, 0.0f),
                            GlyphLayer(
                                    GLYPH_STAR, glyphFont, 10.0f * rescale,
                                    COLOR_GLYPH_GREEN, -1.0f * rescale, -1.0f * rescale))
}
...
fun UiLayout.BLOCK_GLYPH_OPEN_FOLDER(scale: Float): Block.() -> Block {
    val rescale = scale / BASE_SCALE
    return createMultiGlyph(GlyphLayer(
            GLYPH_FOLDER, glyphFont, 16.0f * rescale,
            COLOR_GLYPH_YELLOW, 0.0f, 0.0f),
                            GlyphLayer(
                                    GLYPH_LOAD_ARROW, glyphFont, 12.0f * rescale,
                                    COLOR_GLYPH_BLUE, -1.0f * rescale, -3.0f * rescale))
}
...
fun UiLayout.BLOCK_GLYPH_SAVE(scale: Float): Block.() -> Block {
    val rescale = scale / BASE_SCALE
    return createMultiGlyph(GlyphLayer(
            GLYPH_SAVE, glyphFont, 16.0f * rescale,
            COLOR_GLYPH_BLUE, 0.0f, 0.0f))
}
...
fun UiLayout.BLOCK_GLYPH_CLOSE(scale: Float): Block.() -> Block {
    val rescale = scale / BASE_SCALE
    return createMultiGlyph(GlyphLayer(
            GLYPH_CLOSE, glyphFont, 16.0f * rescale,
            COLOR_GLYPH_RED, 0.0f, 0.0f))
}
...
fun UiLayout.BLOCK_GLYPH_GEAR(scale: Float): Block.() -> Block {
    val rescale = scale / BASE_SCALE
    return createMultiGlyph(GlyphLayer(
            GLYPH_GEAR, glyphFont, 20.0f * rescale,
            COLOR_GLYPH_LIGHT_GREY, 0.0f, 0.0f))
}
...
fun UiLayout.BLOCK_GLYPH_HELP(scale: Float): Block.() -> Block {
    val rescale = scale / BASE_SCALE
    return createMultiGlyph(GlyphLayer(
            GLYPH_CIRCLE, glyphFont, 20.0f * rescale,
            COLOR_GLYPH_DARK_BLUE, 0.0f, 0.0f),
                            GlyphLayer(
                                    GLYPH_HELP, glyphFont, 20.0f * rescale,
                                    COLOR_GLYPH_TRUE_WHITE, 0.0f, 0.0f))
}
...
fun UiLayout.BLOCK_GLYPH_WARNING(scale: Float): Block.() -> Block {
    val rescale = scale / BASE_SCALE
    return createMultiGlyph(GlyphLayer(
            GLYPH_WARNING_TRIANGLE, glyphFont, 20.0f * rescale,
            COLOR_GLYPH_DARK_YELLOW, 0.0f, 0.0f),
                            GlyphLayer(
                                    GLYPH_WARNING, glyphFont, 20.0f * rescale,
                                    COLOR_GLYPH_BLACK, 0.0f, 0.0f))
}
...
fun UiLayout.BLOCK_GLYPH_ERROR(scale: Float): Block.() -> Block {
    ...
    return createMultiGlyph(GlyphLayer(
            GLYPH_CIRCLE, glyphFont, 20.0f * rescale,
            COLOR_GLYPH_DARK_RED, 0.0f, 0.0f),
                            GlyphLayer(
                                    GLYPH_ERROR, glyphFont, 20.0f * rescale,
                                    COLOR_GLYPH_WHITE, 0.0f, 0.0f))
}
