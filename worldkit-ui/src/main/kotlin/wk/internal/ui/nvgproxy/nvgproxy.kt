package wk.internal.ui.nvgproxy
...
class NPTextRow(private val delegate: NVGTextRow.Buffer) {
...
const val NVG_STENCIL_STROKES = NanoVGGL3.NVG_STENCIL_STROKES
const val NVG_HOLE = NanoVG.NVG_HOLE
const val NVG_SOLID = NanoVG.NVG_SOLID
const val NVG_ALIGN_LEFT = NanoVG.NVG_ALIGN_LEFT
const val NVG_ALIGN_RIGHT = NanoVG.NVG_ALIGN_RIGHT
const val NVG_ALIGN_CENTER = NanoVG.NVG_ALIGN_CENTER
const val NVG_ALIGN_TOP = NanoVG.NVG_ALIGN_TOP
const val NVG_ALIGN_BOTTOM = NanoVG.NVG_ALIGN_BOTTOM
const val NVG_ALIGN_MIDDLE = NanoVG.NVG_ALIGN_MIDDLE
...
private fun colorFloatToInt(f: Float) = (f * 255).roundToInt()
