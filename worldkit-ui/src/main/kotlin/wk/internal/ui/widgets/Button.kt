...
import wk.internal.ui.widgets.HorizontalAlignment.CENTER
import wk.internal.ui.widgets.Layout.HORIZONTAL
import wk.internal.ui.widgets.Sizing.SHRINK
...
data class ButtonStyle(
    ...
    inline operator fun invoke(builder: ButtonStyle.() -> ButtonStyle): ButtonStyle {
        return this.builder()
    }
}
