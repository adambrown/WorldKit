...
fun renderTriangle(a: Point2F, b: Point2F, c: Point2F, value: Byte, heightMap: Matrix<Byte>) {
    val stride = heightMap.width
    val strideF = stride.toFloat()
    val p1 = Point2F(a.x * strideF, a.y * strideF)
    val p2 = Point2F(b.x * strideF, b.y * strideF)
    val p3 = Point2F(c.x * strideF, c.y * strideF)
